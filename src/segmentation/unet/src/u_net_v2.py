...
for epoch in tqdm(range(epochs)):
    ...
    text1 = "U_net_v2 Epoch:"+ str(epoch)
    text2 = "Epoch_loss v2: "+str(epoch_loss)+" Step_losses v2: "+str(loss.item())
    text3 = "-------------------"
...
plt.savefig('/scratch/mkolpe2s/MT/code/result_v2/validation.pdf')
...
#     dataset = "/home/latai/Documents/Master_thesis_v2/data/test4/label_train_n/"
    ...
    plt.savefig('/scratch/mkolpe2s/MT/code/result_v2/'+title+'.pdf')
