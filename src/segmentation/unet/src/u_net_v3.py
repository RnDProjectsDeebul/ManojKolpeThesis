...
with open('/scratch/mkolpe2s/MT/code/result_v3/data_loader.pkl', 'wb') as fp:
...
for epoch in tqdm(range(epochs)):
    ...
    text1 = "U_net_v3 Epoch:"+ str(epoch)
    text2 = "Epoch_loss v3: "+str(epoch_loss)+" Step_losses v3: "+str(loss.item())
    text3 = "-------------------"
...
with open('/scratch/mkolpe2s/MT/code/result_v3/epoch_losses.pkl', 'wb') as fp:
    pickle.dump(epoch_losses, fp)

with open('/scratch/mkolpe2s/MT/code/result_v3/step_losses.pkl', 'wb') as fp:
    pickle.dump(step_losses, fp)

model_name = "/scratch/mkolpe2s/MT/code/result_v3/U-Net.pth"
...
with open('/scratch/mkolpe2s/MT/code/result_v3/X.pkl', 'wb') as fp:
    pickle.dump(X, fp)

with open('/scratch/mkolpe2s/MT/code/result_v3/Y.pkl', 'wb') as fp:
    pickle.dump(Y, fp)

with open('/scratch/mkolpe2s/MT/code/result_v3/D.pkl', 'wb') as fp:
    pickle.dump(Y, fp)

with open('/scratch/mkolpe2s/MT/code/result_v3/Y_pred.pkl', 'wb') as fp:
...
plt.savefig('/scratch/mkolpe2s/MT/code/result_v3/validation.pdf')
...
#     dataset = "/home/latai/Documents/Master_thesis_v2/data/test4/label_train_n/"
    ...
    plt.savefig('/scratch/mkolpe2s/MT/code/result_v3/'+title+'.pdf')
