...
with open('/scratch/mkolpe2s/MT/code/result_v4/data_loader.pkl', 'wb') as fp:
...
for epoch in tqdm(range(epochs)):
    ...
    text1 = "U_net_v4 Epoch_80:"+ str(epoch)
    text2 = "Epoch_loss v4_80: "+str(epoch_loss)+" Step_losses v2: "+str(loss.item())
    text3 = "-------------------"
    bot.sendMessage(675791133, text1)
    bot.sendMessage(675791133, text2)
    bot.sendMessage(675791133, text3)

with open('/scratch/mkolpe2s/MT/code/result_v4/epoch_losses.pkl', 'wb') as fp:
    pickle.dump(epoch_losses, fp)

with open('/scratch/mkolpe2s/MT/code/result_v4/step_losses.pkl', 'wb') as fp:
    pickle.dump(step_losses, fp)

model_name = "/scratch/mkolpe2s/MT/code/result_v4/U-Net.pth"
...
with open('/scratch/mkolpe2s/MT/code/result_v4/X.pkl', 'wb') as fp:
    pickle.dump(X, fp)

with open('/scratch/mkolpe2s/MT/code/result_v4/Y.pkl', 'wb') as fp:
    pickle.dump(Y, fp)

with open('/scratch/mkolpe2s/MT/code/result_v4/Y_pred.pkl', 'wb') as fp:
...
plt.savefig('/scratch/mkolpe2s/MT/code/result_v4/validation.pdf')
...
#     dataset = "/home/latai/Documents/Master_thesis_v2/data/test4/label_train_n/"
    ...
    plt.savefig('/scratch/mkolpe2s/MT/code/result_v4/'+title+'.pdf')
