...
\begin{document}
	...
	\begin{figure}%
		...
		\qquad
		\subfloat[\centering Kernel matrix depicted as heatmap 	label]{{\includegraphics[width=7cm]{images/Y_predicted_gp.png} }}%
	...
	\begin{figure}%
		...
		\qquad
		\subfloat[\centering Kernel matrix depicted as heatmap 	label]{{\includegraphics[width=7cm]{images/Y_predicted_lstm.png} }}%
