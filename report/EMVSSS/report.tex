...
\title{Multi-View Temporal Fusion in Semantic Segmentation}
...
\subfile{chapters/ch05_evaluation_and_result}
\subfile{chapters/ch06_android_deployment}
...
\bibliography{references} % Use the bibliography.bib file as the source of references
\nocite{*}
